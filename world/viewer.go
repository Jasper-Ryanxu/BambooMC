...
type EntityViewer interface {
	...
	ViewSetEntityData(id int32, items []EntityDataItem)
	ViewTakeItemEntity(itemID, playerID int32, count pk.VarInt)
}

// EntityDataItem is a single metadata entry for SetEntityData.
type EntityDataItem struct {
